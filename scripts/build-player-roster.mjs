...
if (selected.length !== 200) throw new Error(`Expected 200 players, got ${selected.length}`)
...
function add(player) {
  ...
  if (!player || selectedIds.has(player.transfermarktId) || selectedNames.has(normalizedName) || selected.length >= 200) return
