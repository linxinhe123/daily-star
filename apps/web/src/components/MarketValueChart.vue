...
import type { MarketValuePoint } from '../player-data'
...
<template>
  <div class="market-chart">
    <svg viewBox="0 0 600 220" role="img" aria-label="球员身价变化折线图">
      ...
      <g v-for="point in coords" :key="point.year"><circle :cx="point.x" :cy="point.y" r="4"/><text :x="point.x" :y="point.y-10" text-anchor="middle">€{{ point.value }}m</text><text :x="point.x" y="209" text-anchor="middle" class="year">{{ point.year }}</text></g>
    </svg>
  </div>
</template>
