...
export const featuredPlayers: Player[] = [
  ...
  { slug:'diego-maradona', name:'Diego Maradona', zh:'马拉多纳', aliases:['迭戈马拉多纳','maradona'], nation:'阿根廷', flag:'🇦🇷', position:'前腰 / 影锋', years:'1976—1997', number:10, kicker:'一个人扛着整支球队穿越时代', intro:'兼具街头想象力与惊人对抗能力的左脚大师。他在 1986 年世界杯留下足球史上最浓烈、也最矛盾的一段个人英雄叙事。', clues:['我是一名已经退役的南美 10 号。','我曾让一座意大利南部城市疯狂。','我的左脚和强壮下盘是标志。','一场比赛里，我留下两个完全不同的著名进球。','1986 年世界杯属于我。'], timeline:[{year:'1976',title:'职业首秀',text:'15 岁亮相阿根廷顶级联赛。'},{year:'1982',title:'加盟巴萨',text:'首次登陆欧洲足坛。'},{year:'1984',title:'那不勒斯时代',text:'带领球队两夺意甲。'},{year:'1986',title:'世界杯封王',text:'以队长身份率阿根廷夺冠。'},{year:'1997',title:'结束球员生涯',text:'在博卡青年退役。'}], honors:['世界杯冠军','2× 意甲冠军','联盟杯冠军'], match:'1986 世界杯 · 阿根廷 vs 英格兰', fact:'他在那不勒斯的 10 号球衣被永久退役。', image:commons('Diego Maradona 2017.jpg'), credit:'Wikimedia Commons · CC licensed' },
  { slug:'pele', name:'Pelé', zh:'贝利', aliases:['球王贝利','pele'], nation:'巴西', flag:'🇧🇷', position:'影锋 / 中锋', years:'1956—1977', number:10, kicker:'让 10 号成为世界足球的王冠', intro:'技术全面、效率惊人且富有创造力的第一代全球足球偶像。三座世界杯冠军至今仍是独一无二的球员纪录。', clues:['我来自足球王国。','我十几岁便参加世界杯。','我的大部分俱乐部生涯留在祖国。','我帮助足球在北美扩大影响。','我是唯一三夺世界杯的球员。'], timeline:[{year:'1956',title:'桑托斯首秀',text:'15 岁开启职业生涯。'},{year:'1958',title:'少年世界冠军',text:'17 岁在决赛梅开二度。'},{year:'1962',title:'成功卫冕',text:'巴西连续两届夺冠。'},{year:'1970',title:'第三座世界杯',text:'作为核心率巴西永久保留雷米特杯。'},{year:'1977',title:'纽约告别',text:'在宇宙队结束职业生涯。'}], honors:['3× 世界杯冠军','2× 解放者杯冠军'], match:'1970 世界杯决赛 · 巴西 vs 意大利', fact:'贝利的比赛录像有限，但他的全面性远超“禁区射手”的标签。', image:commons('Pele by John Mathew Smith.jpg'), credit:'Wikimedia Commons · CC BY-SA' },
  { slug:'johan-cruyff',name:'Johan Cruyff',zh:'克鲁伊夫',aliases:['约翰克鲁伊夫','cruyff'],nation:'荷兰',flag:'🇳🇱',position:'中锋 / 前腰',years:'1964—1984',number:14,kicker:'先改变球场，再改变足球思想',intro:'全攻全守足球的场上化身。克鲁伊夫不仅以优雅转身和空间理解统治比赛，退役后更塑造了巴塞罗那的现代足球哲学。',clues:['我来自橙衣军团。','我最具代表性的号码不是 10 号。','有一种著名转身以我命名。','我在两家欧洲豪门都留下深远影响。','我代表全攻全守足球。'],timeline:[{year:'1964',title:'阿贾克斯首秀',text:'开启荷兰王朝。'},{year:'1971',title:'欧冠三连冠起点',text:'阿贾克斯统治欧洲。'},{year:'1973',title:'加盟巴萨',text:'帮助球队重夺西甲。'},{year:'1974',title:'世界杯亚军',text:'全攻全守震撼世界。'},{year:'1988',title:'执教巴萨',text:'建立梦一队基础。'}],honors:['3× 金球奖','3× 欧冠冠军','世界杯亚军'],match:'1974 世界杯 · 荷兰 vs 巴西',fact:'他坚持穿 14 号，让非传统主力号码成为传奇符号。',image:commons('Johan Cruyff 1974c.jpg'),credit:'Wikimedia Commons · public domain/CC'},
  { slug:'franz-beckenbauer',name:'Franz Beckenbauer',zh:'贝肯鲍尔',aliases:['弗朗茨贝肯鲍尔','beckenbauer','足球皇帝'],nation:'德国',flag:'🇩🇪',position:'清道夫 / 中卫',years:'1964—1983',number:5,kicker:'从后场开始优雅地统治比赛',intro:'“足球皇帝”将自由人位置提升为组织核心，以从容推进、预判和领导力重新定义后卫的上限。',clues:['我是一名欧洲传奇后卫。','我被称为皇帝。','我让自由人位置成为战术核心。','我曾效力拜仁慕尼黑。','我以球员和教练身份都赢得世界杯。'],timeline:[{year:'1964',title:'拜仁首秀',text:'开启俱乐部传奇。'},{year:'1972',title:'欧洲杯冠军',text:'率西德登顶欧洲。'},{year:'1974',title:'世界杯冠军',text:'作为队长主场夺冠。'},{year:'1976',title:'欧冠三连冠',text:'完成欧洲霸业。'},{year:'1990',title:'教练世界杯',text:'率队再次夺冠。'}],honors:['世界杯冠军','欧洲杯冠军','2× 金球奖','3× 欧冠冠军'],match:'1974 世界杯决赛 · 西德 vs 荷兰',fact:'他是极少数以球员和主教练身份都获得世界杯的人。',image:commons('Franz Beckenbauer 22-6-74.png'),credit:'Wikimedia Commons · CC licensed'},
  { slug:'zinedine-zidane',name:'Zinedine Zidane',zh:'齐达内',aliases:['齐祖','齐内丁齐达内','zidane'],nation:'法国',flag:'🇫🇷',position:'前腰',years:'1989—2006',number:10,kicker:'最拥挤的空间里仍然从容转身',intro:'以第一脚触球、马赛回旋和大赛表现著称的中场艺术家。他的职业生涯同时拥有最优雅与最戏剧性的画面。',clues:['我出生在法国南部。','我的父母来自北非。','一种回旋动作常与我联系。','我在世界杯决赛中打进过三个球。','退役后我率队实现欧冠三连冠。'],timeline:[{year:'1989',title:'戛纳首秀',text:'踏入法国职业足坛。'},{year:'1996',title:'加盟尤文',text:'成为欧洲顶级中场。'},{year:'1998',title:'世界杯冠军',text:'决赛头球梅开二度。'},{year:'2002',title:'天外飞仙',text:'欧冠决赛凌空制胜。'},{year:'2006',title:'世界杯告别',text:'以决赛结束球员生涯。'}],honors:['世界杯冠军','欧洲杯冠军','金球奖','欧冠冠军'],match:'2006 世界杯 · 法国 vs 巴西',fact:'他在皇马球员和教练时期都赢得了欧冠。',image:commons('Zinedine Zidane by Tasnim 03.jpg'),credit:'Wikimedia Commons · CC BY-SA'},
  { slug:'ronaldo-nazario',name:'Ronaldo Nazário',zh:'罗纳尔多',aliases:['大罗','外星人','罗纳尔多纳扎里奥','ronaldo nazario'],nation:'巴西',flag:'🇧🇷',position:'中锋',years:'1993—2011',number:9,kicker:'巅峰速度与技术结合的终极中锋',intro:'“外星人”把爆发启动、连续变向和门前冷静组合在一个强壮身体里。即使重伤改变轨迹，他依然完成世界杯救赎。',clues:['我是巴西 9 号。','我被称为外星人。','我效力过西班牙和意大利的多家豪门。','严重膝伤几乎终结我的生涯。','2002 年我以 8 球赢得世界杯金靴。'],timeline:[{year:'1993',title:'克鲁塞罗成名',text:'少年赛季高效进球。'},{year:'1996',title:'巴萨惊艳',text:'展示不可阻挡的突破。'},{year:'1998',title:'世界杯决赛',text:'决赛前突发状况留下悬念。'},{year:'2000',title:'膝伤重创',text:'经历漫长康复。'},{year:'2002',title:'王者归来',text:'世界杯决赛梅开二度。'}],honors:['2× 世界杯冠军','2× 金球奖','3× 世界足球先生'],match:'2002 世界杯决赛 · 巴西 vs 德国',fact:'他先后效力过巴塞罗那与皇家马德里，也效力过国际米兰与 AC 米兰。',image:commons('Ronaldo 2013.jpg'),credit:'Wikimedia Commons · CC BY'},
  { slug:'ronaldinho',name:'Ronaldinho',zh:'罗纳尔迪尼奥',aliases:['小罗','罗纳尔迪尼奥高乔','ronaldinho'],nation:'巴西',flag:'🇧🇷',position:'左边锋 / 前腰',years:'1998—2015',number:10,kicker:'让胜负之外的快乐重回足球',intro:'牛尾巴、no-look pass、任意球与永远的笑容，小罗的巅峰不算漫长，却定义了一代人爱上足球的方式。',clues:['我来自巴西南部。','哥哥也曾是职业球员。','我的技术动作带有强烈桑巴色彩。','我曾在伯纳乌赢得主队球迷掌声。','人们常叫我小罗。'],timeline:[{year:'1998',title:'格雷米奥首秀',text:'在家乡开启职业生涯。'},{year:'2002',title:'世界杯冠军',text:'与 3R 组合登顶。'},{year:'2003',title:'加盟巴萨',text:'带领俱乐部复兴。'},{year:'2005',title:'金球奖',text:'登上个人巅峰。'},{year:'2006',title:'欧冠冠军',text:'率巴萨再登欧洲之巅。'}],honors:['世界杯冠军','金球奖','欧冠冠军','解放者杯冠军'],match:'2005 西甲 · 皇家马德里 vs 巴塞罗那',fact:'他是少数集齐世界杯、欧冠、解放者杯和金球奖的球员。',image:commons('Ronaldinho in 2019.jpg'),credit:'Wikimedia Commons · CC licensed'},
  { slug:'thierry-henry',name:'Thierry Henry',zh:'亨利',aliases:['蒂埃里亨利','海布里之王','henry'],nation:'法国',flag:'🇫🇷',position:'中锋 / 左边锋',years:'1994—2014',number:14,kicker:'从左侧走廊划出最优雅的弧线',intro:'速度、节奏变化与远角推射是亨利的签名。他是阿森纳不败之师的攻击核心，也是英超历史最完整的前锋之一。',clues:['我是法国前锋。','我曾在意大利短暂停留。','14 号成为我的标志。','我是不败赛季球队的头号攻击手。','我的庆祝雕像站在伦敦一座球场外。'],timeline:[{year:'1994',title:'摩纳哥首秀',text:'由温格发掘。'},{year:'1998',title:'世界杯冠军',text:'成为法国队内最佳射手。'},{year:'1999',title:'加盟阿森纳',text:'从边锋转型顶级中锋。'},{year:'2004',title:'不败夺冠',text:'率队完成英超不败赛季。'},{year:'2009',title:'巴萨六冠',text:'完成俱乐部荣誉拼图。'}],honors:['世界杯冠军','欧洲杯冠军','欧冠冠军','2× 英超金靴'],match:'2004 英超 · 阿森纳 vs 利物浦',fact:'他至今仍是阿森纳队史正式比赛最佳射手。',image:commons('Thierry Henry in 2021.jpg'),credit:'Wikimedia Commons · CC BY-SA'},
  { slug:'paolo-maldini',name:'Paolo Maldini',zh:'马尔蒂尼',aliases:['保罗马尔蒂尼','maldini'],nation:'意大利',flag:'🇮🇹',position:'左后卫 / 中卫',years:'1985—2009',number:3,kicker:'防守不是破坏，而是提前完成选择',intro:'横跨四分之一个世纪的米兰队魂，既是边路标杆，也是中卫典范。位置感、节奏判断和职业寿命共同构成传奇。',clues:['我的父亲也是著名球员。','我整个职业生涯只效力一家俱乐部。','我能踢左后卫和中后卫。','3 号球衣因我暂时封存。','我参加过八次欧冠决赛。'],timeline:[{year:'1985',title:'米兰首秀',text:'16 岁登场。'},{year:'1989',title:'首夺欧冠',text:'开启欧洲王朝。'},{year:'1994',title:'双冠巅峰',text:'欧冠决赛零封巴萨。'},{year:'2003',title:'队长捧杯',text:'点球击败尤文。'},{year:'2009',title:'圣西罗告别',text:'结束 24 年一线队生涯。'}],honors:['5× 欧冠冠军','7× 意甲冠军','世界杯亚军'],match:'1994 欧冠决赛 · AC 米兰 vs 巴塞罗那',fact:'他代表 AC 米兰参加了 900 多场正式比赛。',image:commons('Paolo Maldini 2008.jpg'),credit:'Wikimedia Commons · CC licensed'},
  ...
  { slug:'xavi',name:'Xavi Hernández',zh:'哈维',aliases:['哈维埃尔南德斯','xavi'],nation:'西班牙',flag:'🇪🇸',position:'中前卫',years:'1998—2019',number:6,kicker:'用扫描和传球控制比赛的时间',intro:'哈维并不依赖速度或身体，而是用持续观察、接球朝向和精确传递掌握空间。他是巴萨与西班牙黄金时代的节拍器。',clues:['我出自拉玛西亚。','我是一名身材不高的中场。','6 号是我的代表号码。','我与另一位中场搭档赢得世界杯。','退役后我回到母队执教。'],timeline:[{year:'1998',title:'巴萨首秀',text:'进入一线队。'},{year:'2008',title:'欧洲杯最佳',text:'率西班牙打破冠军荒。'},{year:'2009',title:'六冠王',text:'成为瓜迪奥拉体系核心。'},{year:'2010',title:'世界杯冠军',text:'控制西班牙中场。'},{year:'2015',title:'三冠告别',text:'队长身份捧起欧冠。'}],honors:['世界杯冠军','2× 欧洲杯冠军','4× 欧冠冠军'],match:'2011 欧冠决赛 · 巴塞罗那 vs 曼联',fact:'他在 2008 欧洲杯被评为赛事最佳球员。',image:commons('Xavi 13981129001173637176624731765221.jpg'),credit:'Wikimedia Commons · CC licensed'},
